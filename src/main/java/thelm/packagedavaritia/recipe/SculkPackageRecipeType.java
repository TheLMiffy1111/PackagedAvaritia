...
public class SculkPackageRecipeType implements IPackageRecipeType {
	...
	public static final ResourceLocation NAME = ResourceLocation.parse("packagedavaritia:sculk");
	public static final IntSet SLOTS;
	public static final List<ResourceLocation> CATEGORIES = List.of(ResourceLocation.parse("avaritia:sculk_craft"));
	public static final List<ResourceLocation> CATEGORIES_EMI = List.of(ResourceLocation.parse("avaritia:sculk_crafting_table"));
