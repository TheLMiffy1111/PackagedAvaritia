...
public class NetherPackageRecipeInfo implements IExtremePackageRecipeInfo {
	...
	public boolean equals(Object obj) {
		if(obj instanceof NetherPackageRecipeInfo) {
			NetherPackageRecipeInfo other = (NetherPackageRecipeInfo)obj;
	...
	public static IExtremeCraftRecipe getRecipe(IInventory matrix, World world) {
		...
		{
			recipe = recipeManager.getRecipeFor(RecipeTypeRegistry.NETHER_CRAFT_RECIPE, matrix, world).orElse(null);
		}
		if(recipe == null) {
			recipe = recipeManager.getRecipeFor(RecipeTypeRegistry.NETHER_CRAFT_SHAPE_RECIPE, matrix, world).orElse(null);
		}
		return recipe;
	}
}
