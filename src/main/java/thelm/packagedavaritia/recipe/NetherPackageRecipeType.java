...
public class NetherPackageRecipeType implements IPackageRecipeType {
	...
	public static final List<ResourceLocation> CATEGORIES = ImmutableList.of(
			new ResourceLocation("endless:nether_craft"),
			new ResourceLocation("endless:nether_craft_shape"));
	...
	public IFormattableTextComponent getDisplayName() {
		return new TranslationTextComponent("recipe.packagedavaritia.nether");
	}

	@Override
	public IFormattableTextComponent getShortDisplayName() {
		return new TranslationTextComponent("recipe.packagedavaritia.nether.short");
	}
	...
	public Object getRepresentation() {
		return new ItemStack(EndlessBlocks.netherCraftingTable.get());
	}
