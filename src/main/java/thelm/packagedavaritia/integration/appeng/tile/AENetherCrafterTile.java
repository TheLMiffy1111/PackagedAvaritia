package thelm.packagedavaritia.integration.appeng.tile;
...
public class AENetherCrafterTile extends NetherCrafterTile implements IGridHost, IActionHost {

	public boolean firstTick = true;
	public BaseGridBlock<AENetherCrafterTile> gridBlock;
	public IActionSource source;
	public IGridNode gridNode;

	public AENetherCrafterTile() {
		super();
