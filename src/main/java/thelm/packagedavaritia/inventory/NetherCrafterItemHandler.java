...
public class NetherCrafterItemHandler extends BaseItemHandler<NetherCrafterTile> {

	public NetherCrafterItemHandler(NetherCrafterTile tile) {
		super(tile, 27);
	}
	...
	public IItemHandlerModifiable getWrapperForDirection(Direction side) {
		return wrapperMap.computeIfAbsent(side, s->new NetherCrafterItemHandlerWrapper(this, s));
	}
