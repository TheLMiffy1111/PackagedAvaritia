...
public class SculkCrafterItemHandlerWrapper extends SidedItemHandlerWrapper<SculkCrafterItemHandler> {

	public static final int[] SLOTS = IntStream.rangeClosed(0, 9).toArray();

	public SculkCrafterItemHandlerWrapper(SculkCrafterItemHandler itemHandler, Direction direction) {
