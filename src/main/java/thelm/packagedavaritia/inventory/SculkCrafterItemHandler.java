...
public class SculkCrafterItemHandler extends BaseItemHandler<SculkCrafterBlockEntity> {
	...
	public IItemHandlerModifiable getWrapperForDirection(Direction side) {
		return wrapperMap.computeIfAbsent(side, s->new SculkCrafterItemHandlerWrapper(this, s));
	}
